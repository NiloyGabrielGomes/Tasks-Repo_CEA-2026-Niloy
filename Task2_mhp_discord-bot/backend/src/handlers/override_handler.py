# Handles /override-update slash command and override button interactions
import logging
...
def handle_override_update(
    ...
    try:
        ...
        # Derive target employee's team from resolved member roles
        target_team = None
        ...
        # Get current state for the target employee
...
def handle_override_meal(
    ...
    try:
        ...
        # Derive target team (best-effort from stored record)
